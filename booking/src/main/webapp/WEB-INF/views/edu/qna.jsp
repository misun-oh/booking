...
<body>
	...
	<!-- Q&A 게시판 상단 배너 -->
	<div class="banner">
		<img src="res/img/qna1.jpg" alt="Q&A 배너 이미지">
	</div>
	...
	<div class="form-container">
		...
		<center>
			<h2
				style="font-size: 28px; font-weight: bold; color: #022703; margin-bottom: 15px;">Q&A
				게시판</h2>
		</center>
		<center>
			<p
				style="font-size: 10px; font-weight: bold; color: #5c5c5c; margin-bottom: 15px;">
