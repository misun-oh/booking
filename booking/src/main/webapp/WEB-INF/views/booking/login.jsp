...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{
      margin:0;
      font-family: system-ui, -apple-system, Segoe UI, Roboto, "Noto Sans KR", Helvetica, Arial, "Apple SD Gothic Neo", "맑은 고딕", "Malgun Gothic", sans-serif;
      color:var(--brand-ink);
      background:#fff;
    }
    .wrap{
    ...
    .label{
      font-size:13px;color:#9a9a9a;padding-left:4px;
    }
    .input{
      width:100%;
    ...
    .links{
      ...
      font-size:13px;margin-top:10px;color:#6d6d6d;
    }
    .links a{
      color:inherit;text-decoration:none;position:relative;padding:2px 0;
    }
    .links a:hover{color:#000;text-decoration:underline}
    /* 브랜드 아이콘 */
    .logo{
      width:min(30vw,220px);height:auto;display:block;
      margin-inline:auto;
    }
    /* 작은 화면 여백 */
    ...
    <div class="stack">
      ...
      <section class="card">
        ...
        <form action="/main" method="post" autocomplete="on">
          ...
          <div class="field">
            <label class="label" for="loginPw">패스워드</label>
            <input class="input" id="loginPw" name="loginPw" type="password" placeholder="패스워드" required />
          </div>
