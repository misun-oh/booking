...
CREATE TABLE `lesson` (
	...
	`lesson_order`	VARCHAR(250)	NULL,
	`file_id`	INT	NULL,
	`lesson_explan`	VARCHAR(500)	NULL,
	`fix_time`	LocalDateTime	NULL,
	`delete_time`	LocalDateTime	NULL,
	`resgistration_time`	LocalDateTime	NULL,
	`saved.parh`	VARCHAR	NULL
);
